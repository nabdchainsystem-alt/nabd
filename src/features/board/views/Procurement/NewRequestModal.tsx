                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-8 bg-gray-50/50 dark:bg-[#15171b]">
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <div className="flex items-center justify-between h-5 mb-1">
                                    <label className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Request ID</label>
                                    <button
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <div className="flex items-center h-5 mb-1">
                                    <label className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Department</label>
                                </div>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center h-5 mb-1">
                                    <label className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Warehouse</label>
                                </div>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <div className="flex items-center h-5 mb-1">
                                    <label className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Priority Status</label>
                                </div>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center h-5 mb-1">
                                    <label className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Related To</label>
                                </div>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
