...
export const CoverPicker: React.FC<CoverPickerProps> = ({ onSelect, onRemove, onClose }) => {
                ...
                <div className="flex items-center gap-1">
                    {TABS.map(tab => (
                        <button
                            ...
                            className={`px-3 py-2 text-sm font-medium rounded-t-lg border-b-2 transition-colors ${activeTab === tab.id
