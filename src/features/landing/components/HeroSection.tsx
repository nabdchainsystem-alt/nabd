...
export const HeroSection: React.FC<{ onEnterSystem?: () => void }> = ({ onEnterSystem }) => {
    return (
        <section className="relative pt-32 pb-40 px-6 overflow-hidden">
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        border border-zinc-200 hover:bg-zinc-50 hover:text-zinc-900 transition-all flex items-center gap-2 group">
            ...
            <div className="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-zinc-200 to-transparent" />
            <div className="absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-zinc-200 to-transparent" />
        </section>
    );
};
