                ...
                <>
                    ...
                    <div className="px-8 pt-8 pb-6 flex-shrink-0">
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                <h1 className="text-3xl font-extrabold text-[#323338] dark:text-white mb-1 tracking-tight">{t('team_overview')}</h1>
                        ...
                        <div className="bg-white dark:bg-monday-dark-surface rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-gray-100 dark:border-monday-dark-border h-full flex flex-col overflow-hidden">
                            ...
                            <div className="p-4 border-b border-gray-100 dark:border-monday-dark-border flex items-center justify-between flex-shrink-0 bg-white dark:bg-monday-dark-surface z-10">
                                ...
                                <div className="relative group">
                                    <Search className="absolute start-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-monday-blue transition-colors" size={16} />
                                    <input
                                        type="text"
                            ...
                            <div className="flex-1 overflow-y-auto w-full">
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 text-right">
                                                    ...
                                                    <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity translate-x-2 group-hover:translate-x-0 duration-200 rtl:-translate-x-2 rtl:group-hover:-translate-x-0">
                                                        <button className="p-2 hover:bg-white dark:hover:bg-gray-700 text-gray-400 hover:text-monday-blue rounded-full shadow-sm border border-transparent hover:border-gray-100 transition-all tooltip" title={t('message')}>
                                                            <MessageSquare size={16} />
                                                        </button>
                                                        <button
                                                            onClick={(e) => { e.stopPropagation(); setSelectedMemberId(member.id); }}
                                                            className="p-2 hover:bg-white dark:hover:bg-gray-700 text-gray-400 hover:text-monday-blue rounded-full shadow-sm border border-transparent hover:border-gray-100 transition-all tooltip" title={t('view_profile')}>
                                ...
                                {filteredMembers.length === 0 && (
                                    <div className="flex flex-col items-center justify-center py-20 text-center">
                                        ...
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">{t('no_members_found')}</h3>
