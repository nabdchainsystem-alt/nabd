                            ...
                            <div className="flex items-start justify-between mb-4">
                                <div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border ${member.status === 'Active' ? 'bg-green-50 text-green-700 border-green-200 dark:bg-green-900/30 dark:text-green-300 dark:border-green-800' :
                                            member.status === 'Invited' ? 'bg-yellow-50 text-yellow-700 border-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-300 dark:border-yellow-800' :
                        ...
                        <div className="flex gap-8">
                            {['Overview', 'Performance', 'Activity'].map((tab) => (
                                <button
                                    ...
                                    className={`pb-3 font-medium text-sm transition-colors relative ${activeTab === tab.toLowerCase()
