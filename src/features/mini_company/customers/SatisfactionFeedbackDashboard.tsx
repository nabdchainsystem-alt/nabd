...
const NPS_BY_SEGMENT = [
    { name: 'Enterprise', NPS: 55 },
    { name: 'Mid-Market', NPS: 42 },
    { name: 'SMB', NPS: 38 },
    { name: 'Startup', NPS: 30 },
];

const RATING_DISTRIBUTION = [
    { value: 45, name: '5 Stars' },
    { value: 33, name: '4 Stars' },
    { value: 14, name: '3 Stars' },
    { value: 8, name: '1-2 Stars' }
];
...
export const SatisfactionFeedbackDashboard: React.FC = () => {
    ...
    const ratingPieOption: EChartsOption = {
        tooltip: { trigger: 'item' },
        legend: { bottom: 0, left: 'center', itemWidth: 10, itemHeight: 10 },
        series: [{
            type: 'pie',
        ...
        <div className="p-6 bg-white dark:bg-monday-dark-surface min-h-full font-sans text-gray-800 dark:text-gray-200 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="col-span-1 md:col-span-2 lg:col-span-3 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-monday-dark-elevated p-5 rounded-2xl border border-gray-100 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-shadow">
                        <div className="mb-4">
                            <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200 uppercase tracking-wider">NPS by Segment</h3>
                            <p className="text-xs text-gray-400">Net Promoter Score</p>
                        </div>
                        <div className="h-[220px] w-full">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={NPS_BY_SEGMENT} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                                    <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f3f4f6" />
                                    <XAxis dataKey="name" fontSize={10} tick={{ fill: '#9ca3af' }} />
                                    <YAxis fontSize={10} tick={{ fill: '#9ca3af' }} />
                                    <Tooltip
                                        ...
                                        contentStyle={{ borderRadius: '8px', border: 'none', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}
                                    />
                                    <Bar dataKey="NPS" fill="#eab308" radius={[4, 4, 0, 0]} barSize={28} />
                                </BarChart>
                            </ResponsiveContainer>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-monday-dark-elevated p-5 rounded-2xl border border-gray-100 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-shadow">
                        <div className="mb-2">
                            <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200 uppercase tracking-wider">Rating Distribution</h3>
                            <p className="text-xs text-gray-400">Star Ratings</p>
                        </div>
                        <ReactECharts option={ratingPieOption} style={{ height: '200px' }} />
                    </div>
