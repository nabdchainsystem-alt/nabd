...
export const SupplierStrategicValueGrowthDashboard: React.FC = () => {
    ...
    const TRANSLATED_TOP_KPIS = useMemo(() => [
        { id: '1', label: t('strategic_suppliers'), subtitle: t('tier_1_partners'), value: '12', change: '+1', trend: 'up' as const, icon: <Crown size={18} />, sparklineData: [10, 11, 11, 11, 12, 12], color: 'blue' },
        { id: '2', label: t('spend_growth_pct'), subtitle: t('yoy_increase'), value: '+18%', change: '+3%', trend: 'up' as const, icon: <TrendUp size={18} />, sparklineData: [12, 14, 15, 16, 17, 18], color: 'blue' },
        { id: '3', label: t('innovation_score'), subtitle: t('avg_rating'), value: '8.5', change: '+0.2', trend: 'up' as const, icon: <Lightbulb size={18} />, sparklineData: [8.0, 8.1, 8.2, 8.3, 8.4, 8.5], color: 'blue' },
        { id: '4', label: t('partnership_index'), subtitle: t('relationship_strength'), value: '92', change: t('stable'), trend: 'neutral' as const, icon: <Handshake size={18} />, sparklineData: [90, 91, 91, 92, 92, 92], color: 'blue' },
    ], [t]);
    ...
    const TRANSLATED_SPEND_GROWTH = useMemo(() => [
    ...
    const TRANSLATED_VALUE_BY_SUPPLIER = useMemo(() => [
