...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div
      ...
      className="flex flex-col h-full border-e border-stone-200 dark:border-stone-800 bg-stone-50/50 dark:bg-stone-900/50 backdrop-blur-xl relative group"
    >
      {/* Header Area */}
                    ...
                    <div
                      ...
                      className={`
                        ...
                        ${activeThreadId === thread.id
                          ? 'bg-white dark:bg-stone-800 border-s-4 border-s-stone-600 dark:border-s-stone-400 ps-3 shadow-sm ring-1 ring-stone-200 dark:ring-stone-700'
                          : 'hover:bg-stone-100 dark:hover:bg-stone-800/50 border-s-4 border-s-transparent hover:ps-3.5 ps-4'}
                      `}
                    >
                      <div className="flex justify-between items-start mb-1">
                        <h3 className={`font-serif text-sm truncate font-medium ${activeThreadId === thread.id ? 'text-stone-900 dark:text-stone-100' : 'text-stone-700 dark:text-stone-300'}`}>
                          {thread.title}
                        </h3>
                      ...
                      <div className="flex justify-between items-end">
                        <p className={`font-serif text-xs line-clamp-1 leading-relaxed flex-1 ${activeThreadId === thread.id ? 'text-stone-500' : 'text-stone-500 dark:text-stone-500'}`}>
                          {thread.preview}
                        </p>
