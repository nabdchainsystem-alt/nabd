...
const translations: Translations = {
  ...
  ai_assistant: { en: 'Your Smart AI Assistant', ar: 'مساعدك الذكي' },
  ...
  cost_allocation_desc: { en: 'Donut chart (ECharts) showing spend distribution by category.', ar: 'مخطط دائري (ECharts) يوضح توزيع الإنفاق حسب الفئة.' },
  savings_breakdown_desc: { en: 'Donut chart (ECharts) showing cost optimization sources (Negotiation, Volume Discount, Contract Terms, Process Efficiency).', ar: 'مخطط دائري (ECharts) يوضح مصادر تحسين التكلفة (التفاوض، خصومات الكمية، شروط العقد، كفاءة العملية).' },
