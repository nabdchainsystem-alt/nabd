...
export const InboxView: React.FC = () => {
  ...
  return (
    <div className="flex h-full w-full bg-white dark:bg-monday-dark-bg overflow-hidden font-sans text-gray-800 dark:text-monday-dark-text" style={{ transform: 'scale(1.1)', transformOrigin: 'top left', width: '90.9%', height: '90.9%' }}>
      ...
      <div className="w-60 bg-[#f7f8fa] dark:bg-monday-dark-surface border-e border-gray-200 dark:border-monday-dark-border flex flex-col flex-shrink-0">
        <div className="p-3 space-y-2">
          <button className="w-full bg-monday-blue hover:bg-blue-600 text-white py-1.5 px-4 rounded shadow-sm flex items-center justify-center gap-2 transition-colors">
            <PenSquare size={14} />
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {/* 2b. Reading Pane */}
          {selectedMail ? (
            <div className="flex-1 bg-white dark:bg-monday-dark-bg overflow-y-auto p-6">
